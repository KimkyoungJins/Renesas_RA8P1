...
{ .p_mipi_csi_instance = &g_mipi_csi0,
  ...
  .input_ctrl.preclip.line_end = 449,
  .input_ctrl.preclip.pixel_start = 0,
  .input_ctrl.preclip.pixel_end = 767,
  ...
  .conversion_data.uds_clipping_bits.cl_vsize = 450,
  .conversion_data.uds_clipping_bits.cl_hsize = 768,
        ...
        .input[0] =
        {
          ...
          .output =
                  ...
                  { .total_cyc = 1334, .display_cyc = 1024, .back_porch = 300, .sync_width = 10, .sync_polarity =
                    ...
                    .vtiming =
                    { .total_cyc = 780, .display_cyc = 600, .back_porch = 30, .sync_width = 5, .sync_polarity =
                              DISPLAY_SIGNAL_POLARITY_LOACTIVE },
          ...
          .line_detect_ipl = (12),
          .underflow_1_ipl = (12), .underflow_2_ipl = (12),
...
{ .p_ctrl = &g_plcd_display_ctrl, .p_cfg = (display_cfg_t*) &g_plcd_display_cfg, .p_api =
...
const icu_extended_cfg_t g_external_irq19_ext_cfg =
...
{ .channel = 19, .trigger = EXTERNAL_IRQ_TRIG_RISING, .filter_enable = false, .clock_source_div =
  ...
  .p_context = (void*) &NULL,
#endif
  .p_extend = (void*) &g_external_irq19_ext_cfg,
  .ipl = (2),
...
/* Instance structure to use this module. */
const external_irq_instance_t g_external_irq19 =
{ .p_ctrl = &g_external_irq19_ctrl, .p_cfg = &g_external_irq19_cfg, .p_api = &g_external_irq_on_icu };
icu_instance_ctrl_t g_external_irq12ds_ctrl;

/** External IRQ extended configuration for ICU HAL driver */
const icu_extended_cfg_t g_external_irq12ds_ext_cfg =
{ .filter_src = EXTERNAL_IRQ_DIGITAL_FILTER_PCLK_DIV, };

const external_irq_cfg_t g_external_irq12ds_cfg =
{ .channel = 12, .trigger = EXTERNAL_IRQ_TRIG_FALLING, .filter_enable = false, .clock_source_div =
          EXTERNAL_IRQ_CLOCK_SOURCE_DIV_64,
  .p_callback = button_irq12_ds_callback,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
  .p_context = (void*) &NULL,
#endif
  .p_extend = (void*) &g_external_irq12ds_ext_cfg,
  .ipl = (12),
...
/* Instance structure to use this module. */
const external_irq_instance_t g_external_irq12ds =
{ .p_ctrl = &g_external_irq12ds_ctrl, .p_cfg = &g_external_irq12ds_cfg, .p_api = &g_external_irq_on_icu };
icu_instance_ctrl_t g_external_irq13ds_ctrl;

/** External IRQ extended configuration for ICU HAL driver */
const icu_extended_cfg_t g_external_irq13ds_ext_cfg =
{ .filter_src = EXTERNAL_IRQ_DIGITAL_FILTER_PCLK_DIV, };

const external_irq_cfg_t g_external_irq13ds_cfg =
{ .channel = 13, .trigger = EXTERNAL_IRQ_TRIG_FALLING, .filter_enable = false, .clock_source_div =
          EXTERNAL_IRQ_CLOCK_SOURCE_DIV_64,
  .p_callback = button_irq13_ds_callback,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
  .p_context = (void*) &NULL,
#endif
  .p_extend = (void*) &g_external_irq13ds_ext_cfg,
  .ipl = (12),
...
/* Instance structure to use this module. */
const external_irq_instance_t g_external_irq13ds =
{ .p_ctrl = &g_external_irq13ds_ctrl, .p_cfg = &g_external_irq13ds_cfg, .p_api = &g_external_irq_on_icu };
...
EventGroupHandle_t g_update_display_event;
#if 1
StaticEventGroup_t g_update_display_event_memory;
#endif
void rtos_startup_err_callback(void *p_instance, void *p_data);
...
void g_common_init(void)
{
    ...
    g_update_display_event =
#if 1
            xEventGroupCreateStatic (&g_update_display_event_memory);
#else
                xEventGroupCreate();
                #endif
    if (NULL == g_update_display_event)
    {
        rtos_startup_err_callback (g_update_display_event, 0);
    }
